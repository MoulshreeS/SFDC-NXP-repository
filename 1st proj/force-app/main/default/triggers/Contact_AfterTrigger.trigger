...
@Description:      SFDC-2798 Provisioning of License - Upgrade the license
                   Based on Contact Service Levels assign different permission sets to users. 
**********************************************************************************************************/
trigger Contact_AfterTrigger on Contact (after insert,after update) 
{
 ...
 if(trigger.isUpdate){
  ...
  // Calling the method in after update to update permission set of user according to the CSL as part of SFDC-2798
     ContactClass.updatePermissionAccordingToCSL(Trigger.new,Trigger.oldMap);
