	...
	ContactDetails : function(cmp) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS"){
                ...
                if(result.caseCurrent.Product__c == null && result.caseCurrent.Product_Category__c == null){
            //alert('Product Level 1 and 2 are required');
                    cmp.set("v.productfields", true);
                    cmp.set("v.producterrormessage",'Product Level 1 and level 2 fields are required');
                        
        }
        if(result.caseCurrent.Product__c != null && result.caseCurrent.Product_Category__c  == null){
            //alert('Product Level 2 is required');
              cmp.set("v.productfields", true);
              cmp.set("v.producterrormessage",'Product  level 2 field is required');
