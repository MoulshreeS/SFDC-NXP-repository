({
	doInit : function(component, event, helper) {
        ...
        component.set("v.CityMandatory", false);
        component.set("v.productfields", false);
    ...
    SetCityChange : function(component, event, helper){
         var Citynameval = component.find("City-Inp").get("v.value"); 		      
        component.set("v.cityVal", Citynameval);  
		},
      ...
      var Map = component.get("v.depnedentFieldMap");
        if(controllerValueKey =='USA' || controllerValueKey =='Canada' || controllerValueKey=='China'){
           ...
           component.set("v.stateMandatory", false); 
                ...
                if(controllerValueKey == 'China'){
            component.set("v.CityMandatory", true);
        }
        else{
            component.set("v.CityMandatory", false);
        }
    ...
    createLeadButton : function(component, event, helper) {                
        ...
        var cityval = component.get("v.cityVal");
       ...
       /* var CountryValueCase=component.get("v.cases.Community_Web_Country__c");
        ...
        if(contryValue =='China'){
            var cityValMandatory = true;            
        }
        ...
        var citynull =component.find("City-Inp");
        ...
        var prodlv1null = component.find("Pro-lv1-Inp");
        ...
        if(casProdLV1 ==null || casProdLV1 ==''){
           
           prodlv1null.set("v.errors", [{message:"Please enter  Product level 1"}]); 
        }
        else{
        ...
        if((zipCodeVal == null && (zipCodeMandatory ==true)) || zipCodeVal ==''){            
           zipNull.set("v.errors", [{message:"Please enter a value"}]); 
            ...
            zipNull.set("v.errors", null);
                ...
                if((cityval ==null || cityval =='') && cityValMandatory == true  ){
           citynull.set("v.errors", [{message:"Please enter a value"}]);
                    var citynullchck = true;
        }
        else{
            citynull.set("v.errors", null);
        }
        ...
        if( conEmail !=null && conComp != null && /*casProdLV3 !=null &&*/ ((regionName !=null &&
          ...
          (conMobPh !=null || conPhoneExist != null) &&*/ conFirstNameExist !=null && conLastNameExist != null &&
           ...
           (stateValMandatory !=true)) && (citynullchck != true) && ((indFinalValue ==true && industryVal !=null) ||
           ...
           contryValue !='' &&  stateValue!='' && industryVal !='' && zipCodeVal !='' )){
        	...
        	action.setParams({ caseId : component.get("v.recordId"),
                              ...
                              accDistiName : distiName, 
                              proLv1 : casProdLV1, proLv2 : casProdLV2,cityval : cityval});            
            action.setCallback(this, function(response){
                var state = response.getState();
            	if (state === "SUCCESS"){                     
                	//window.location.href = '/'+casId;
