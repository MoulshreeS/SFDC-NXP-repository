({
    ...
    createLeadButton : function(component, event, helper) {                
        ...
        if( conEmail !=null  &&  company !='' && ((
           ...
           contryValue !=null && contryValue !='--- None ---' && (statepass != true) && (citynullchck != true) && ((indFinalValue ==true && industryVal !=null) ||
            ...
            if((conEmail !='' &&
                ...
                action.setParams({ contactid : component.get("v.recordId"),
                                  ...
                                  stateValu : stateValue, postalCode : zipCodeVal, 
                                  prodlv1 : prodlv1, prodlv2: prodlv2 , 
                                  prodlv3: prodlv3,prodnum: prodnum,prodId: prodId,
                                  transname: Transname,company: company,cityval: cityval
                                 });            
                action.setCallback(this, function(response){
                    var state = response.getState();
